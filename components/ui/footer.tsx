        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <div>
                    ...
                    Find the jwellery items that fit your style. Go with the trend.
                    </p>
                </div>
                </div>
                ...
                <form className="w-full">
                    ...
                    <button
                        disabled 
                        className="mt-1 w-full bg-teal-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none sm:mt-0 sm:w-auto sm:shrink-0 disabled"
                    >
                        Sign Up
                    </button>
                    </div>
